package com.surfilter.act.thumbnailator.geometry;
...
public enum Positions implements Position {
	 ...
	 * if it is to be placed at the top left-hand corner of the enclosing image.
	 */
	TOP_LEFT() {
	...
	/**
	 * Calculates the {@link Point} at which an enclosed image should be placed
	 * if it is to be placed vertically centered at the left-hand corner of the
	 * enclosing image.
	 */
	CENTER_LEFT() {
		public Point calculate(int enclosingWidth, int enclosingHeight, int width, int height, int insetLeft,
	...
	/**
	 * Calculates the {@link Point} at which an enclosed image should be placed
	 * if it is to be placed vertically centered at the right-hand corner of the
	 * enclosing image.
	 */
	CENTER_RIGHT() {
		public Point calculate(int enclosingWidth, int enclosingHeight, int width, int height, int insetLeft,
