package com.surfilter.act.thumbnailator.makers;

import java.awt.image.BufferedImage;

/**
 * A {@link ThumbnailMaker} which resizes an image to a specified dimension when
 ...
 * <p>
 * In other words, when the aspect ratio is to be kept constant, then thumbnails
 * which are created will be sized to fit inside the dimensions specified by the
 * size parameter.
 * <p>
 ...
 * <DL>
 * <DT><B>Usage:</B></DT>
 * <DD>The following example demonstrates how to create a thumbnail which fits
 ...
 * 
 * BufferedImage thumbnail = new FixedSizeThumbnailMaker().size(200, 200).keepAspectRatio(true).make(img);
 * </pre>
 * 
 * </DD>
 * </DL>
...
public final class FixedSizeThumbnailMaker extends ThumbnailMaker {
	 ...
	 * of the original image should be maintained in the thumbnail must be set
	 * before this instance is able to produce thumbnails.
	 */
	...
	/**
	 * Creates a {@link FixedSizeThumbnailMaker} which creates thumbnails with
	 * the specified size.
	 * <p>
	 ...
	 * 
	 * @param width
	 *            The width of the thumbnail to produce.
	 * @param height
	 *            The height of the thumbnails to produce.
	 */
	...
	/**
	 * Creates a {@link FixedSizeThumbnailMaker} which creates thumbnails with
	 * the specified size. Whether or not the aspect ratio of the original image
	 * should be preserved by the thumbnail is also specified at instantiation.
	 * 
	 * @param width
	 *            The width of the thumbnail to produce.
	 * @param height
	 *            The height of the thumbnails to produce.
	 * @param aspectRatio
	 *            Whether or not to maintain the aspect ratio in the thumbnail
	 *            the same as the original image.
	 *            <p>
	 *            If {@code true} is specified, then the thumbnail image will
	 ...
	 * Creates a {@link FixedSizeThumbnailMaker} which creates thumbnails with
	 * the specified size. Whether or not the aspect ratio of the original image
	 * should be preserved by the thumbnail, and whether to fit the thumbnail
	 * within the given dimensions is also specified at instantiation.
	 * 
	 * @param width
	 *            The width of the thumbnail to produce.
	 * @param height
	 ...
	 *            have the same aspect ratio as the original image.
	 * @param fit
	 *            Whether or not to fit the thumbnail within the specified
	 *            dimensions.
	 *            <p>
	 *            If {@code true} is specified, then the thumbnail will be sized
	 *            to fit within the specified {@code width} and {@code height}.
	 */
	 ...
	 *             If the size has already been previously set, or if the
	 *             {@code width} or {@code height} is less than or equal to
	 *             zero.
	 */
	...
	/**
	 * Sets whether or not the thumbnail is to maintain the aspect ratio of the
	 * original image.
	 * 
	 * @param keep
	 *            Whether or not to maintain the aspect ratio in the thumbnail
	 ...
	 * @return A reference to this object.
	 * @throws IllegalStateException
	 *             If whether to keep the aspect ratio has already been
	 *             previously set.
	 */
	...
	public BufferedImage make(BufferedImage img) {
		...
		if (keepRatio) {
			...
			/*
			 * If the ratios are not the same, then the appropriate width and
			 * height must be picked.
			 */
