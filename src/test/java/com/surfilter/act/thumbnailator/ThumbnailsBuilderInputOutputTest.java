...
import com.surfilter.act.thumbnailator.ThumbnailParameter;
import com.surfilter.act.thumbnailator.Thumbnails;
import com.surfilter.act.thumbnailator.builders.BufferedImageBuilder;
import com.surfilter.act.thumbnailator.builders.ThumbnailParameterBuilder;
import com.surfilter.act.thumbnailator.name.ConsecutivelyNumberedFilenames;
import com.surfilter.act.thumbnailator.name.Rename;
import com.surfilter.act.thumbnailator.test.BufferedImageAssert;
...
public class ThumbnailsBuilderInputOutputTest {
	 ...
	 */
	private static final String TMPDIR = "src/test/resources/tmp/ThumbnailsBuilderInputOutputTest";
	 ...
	 * <ol>
	 * <li>Processing completes successfully. Image format is determined by the
	 * extension of the file.</li>
	 * </ol>
	 */
	@Test
	public void of_BufferedImage_toFile_File_NoOutputFormatSpecified() throws IOException {
		...
		// when
		Thumbnails.of(img).size(100, 100).toFile(destFile);
	...
	public void of_BufferedImage_toFile_String_NoOutputFormatSpecified() throws IOException {
		...
		// when
		Thumbnails.of(img).size(100, 100).toFile(destFilePath);
	...
	public void of_BufferedImage_toFiles_Iterable_NoOutputFormatSpecified() throws IOException {
		...
		// when
		Thumbnails.of(img).size(50, 50).toFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_BufferedImage_asFiles_Iterable_NoOutputFormatSpecified() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.of(img).size(50, 50).asFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_BufferedImage_asBufferedImage_NoOutputFormatSpecified() throws IOException {
		...
		// when
		BufferedImage thumbnail = Thumbnails.of(img).size(100, 100).asBufferedImage();
	...
	public void of_BufferedImage_asBufferedImages_NoOutputFormatSpecified() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.of(img).size(100, 100).asBufferedImages();
	...
	public void of_BufferedImage_toOutputStream_NoOutputFormatSpecified() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img).size(50, 50).toOutputStream(os);
	...
	public void of_BufferedImage_toOutputStreams_NoOutputFormatSpecified() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img).size(50, 50).toOutputStreams(Arrays.asList(os));
	...
	public void of_BufferedImage_iterableBufferedImages_NoOutputFormatSpecified() throws IOException {
		...
		// when
		Iterable<BufferedImage> thumbnails = Thumbnails.of(img).size(50, 50).iterableBufferedImages();
	...
	public void of_BufferedImage_toFile_File_OutputFormatSpecified() throws IOException {
		...
		// when
		Thumbnails.of(img).size(100, 100).outputFormat("png").toFile(destFile);
	...
	public void of_BufferedImage_toFile_String_OutputFormatSpecified() throws IOException {
		...
		// when
		Thumbnails.of(img).size(100, 100).outputFormat("png").toFile(destFilePath);
	...
	public void of_BufferedImage_toFiles_Iterable_OutputFormatSpecified() throws IOException {
		...
		// when
		Thumbnails.of(img1).size(50, 50).outputFormat("png").toFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_BufferedImage_asFiles_Iterable_OutputFormatSpecified() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.of(img1).size(50, 50).outputFormat("png").asFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_BufferedImage_asBufferedImage_OutputFormatSpecified() throws IOException {
		...
		// when
		BufferedImage thumbnail = Thumbnails.of(img).size(100, 100).outputFormat("png").asBufferedImage();
	...
	public void of_BufferedImage_asBufferedImages_OutputFormatSpecified() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.of(img).size(100, 100).outputFormat("png").asBufferedImages();
	...
	public void of_BufferedImage_toOutputStream_OutputFormatSpecified() throws IOException {
		...
		// when
		Thumbnails.of(img).size(50, 50).outputFormat("png").toOutputStream(os);
	...
	public void of_BufferedImage_toOutputStreams_OutputFormatSpecified() throws IOException {
		...
		// when
		Thumbnails.of(img).size(50, 50).outputFormat("png").toOutputStreams(Arrays.asList(os));
	...
	public void of_BufferedImage_iterableBufferedImages_OutputFormatSpecified() throws IOException {
		...
		// when
		Iterable<BufferedImage> thumbnails = Thumbnails.of(img).size(50, 50).outputFormat("png")
	...
	public void of_BufferedImages_toFile_File_NoOutputFormatSpecified() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img, img).size(100, 100).toFile(destFile);
	...
	public void of_BufferedImages_toFile_String_NoOutputFormatSpecified() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img, img).size(100, 100).toFile(destFilePath);
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot output multiple thumbnails to one file.", e.getMessage());
			throw e;
	...
	public void of_BufferedImages_toFiles_Iterable_NoOutputFormatSpecified() throws IOException {
		...
		// when
		Thumbnails.of(img, img).size(50, 50).toFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_BufferedImages_asFiles_Iterable_NoOutputFormatSpecified() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.of(img, img).size(50, 50).asFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_BufferedImages_asBufferedImage_NoOutputFormatSpecified() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img, img).size(100, 100).asBufferedImage();
		} catch (IllegalArgumentException e) {
			// then
	...
	public void of_BufferedImages_asBufferedImages_NoOutputFormatSpecified() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.of(img, img).size(100, 100).asBufferedImages();
	...
	public void of_BufferedImages_toOutputStream_NoOutputFormatSpecified() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img, img).size(50, 50).toOutputStream(os);
	...
	public void of_BufferedImages_toOutputStreams_NoOutputFormatSpecified() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img, img).size(50, 50).toOutputStreams(Arrays.asList(os));
	...
	public void of_BufferedImages_toFile_File_OutputFormatSpecified() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img, img).size(100, 100).outputFormat("png").toFile(destFile);
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot output multiple thumbnails to one file.", e.getMessage());
			throw e;
	...
	public void of_BufferedImages_toFile_String_OutputFormatSpecified() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img, img).size(100, 100).outputFormat("png").toFile(destFilePath);
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot output multiple thumbnails to one file.", e.getMessage());
			throw e;
	...
	public void of_BufferedImages_toFiles_Iterable_OutputFormatSpecified() throws IOException {
		...
		// when
		Thumbnails.of(img, img).size(50, 50).outputFormat("png").toFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_BufferedImages_asFiles_Iterable_OutputFormatSpecified() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.of(img, img).size(50, 50).outputFormat("png").asFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_BufferedImages_asBufferedImage_OutputFormatSpecified() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img, img).size(100, 100).outputFormat("png").asBufferedImage();
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot create one thumbnail from multiple original images.", e.getMessage());
			throw e;
	...
	public void of_BufferedImages_asBufferedImages_OutputFormatSpecified() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.of(img, img).size(100, 100).outputFormat("png").asBufferedImages();
	...
	public void of_BufferedImages_toOutputStream_OutputFormatSpecified() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img, img).size(50, 50).outputFormat("png").toOutputStream(os);
	...
	public void of_BufferedImages_toOutputStreams_OutputFormatSpecified() throws IOException {
		...
		// when
		Thumbnails.of(img, img).size(50, 50).outputFormat("png").toOutputStreams(Arrays.asList(os1, os2));
	...
	public void of_BufferedImages_iterableBufferedImages_OutputFormatSpecified() throws IOException {
		...
		// when
		Iterable<BufferedImage> thumbnails = Thumbnails.of(img, img).size(50, 50).outputFormat("png")
				.iterableBufferedImages();
	...
	public void fromImages_Single_asBufferedImage() throws IOException {
		...
		// when
		BufferedImage thumbnail = Thumbnails.fromImages(Arrays.asList(img)).size(100, 100).asBufferedImage();
	...
	public void fromImages_Multiple_asBufferedImage() throws IOException {
		...
		try {
			// when
			Thumbnails.fromImages(Arrays.asList(img, img)).size(100, 100).asBufferedImage();
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot create one thumbnail from multiple original images.", e.getMessage());
			throw e;
	...
	public void fromImages_Single_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.fromImages(Arrays.asList(img)).size(100, 100).asBufferedImages();
	...
	public void fromImages_Multiple_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.fromImages(Arrays.asList(img, img)).size(100, 100)
				.asBufferedImages();
	...
	public void fromImagesIterable_Single_asBufferedImage() throws IOException {
		...
		// when
		BufferedImage thumbnail = Thumbnails.fromImages((Iterable<BufferedImage>) Arrays.asList(img)).size(100, 100)
				.asBufferedImage();
	...
	public void fromImagesIterable_Multiple_asBufferedImage() throws IOException {
		...
		try {
			// when
			Thumbnails.fromImages((Iterable<BufferedImage>) Arrays.asList(img, img)).size(100, 100).asBufferedImage();
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot create one thumbnail from multiple original images.", e.getMessage());
			throw e;
	...
	public void of_File_toFile() throws IOException {
		...
		// when
		Thumbnails.of(f).size(50, 50).toFile(outFile);
	...
	public void of_File_toFiles_Rename() throws IOException {
		...
		// when
		Thumbnails.of(f1).size(50, 50).toFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void of_File_asFiles_Rename() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.of(f1).size(50, 50).asFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void of_File_toFiles_Iterable() throws IOException {
		...
		// when
		Thumbnails.of(f1).size(50, 50).toFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_File_asFiles_Iterable() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.of(f1).size(50, 50).asFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_File_asBufferedImage() throws IOException {
		...
		// when
		BufferedImage thumbnail = Thumbnails.of(f1).size(50, 50).asBufferedImage();
	...
	public void of_File_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.of(f1).size(50, 50).asBufferedImages();
	...
	public void of_File_toOutputStream() throws IOException {
		...
		// when
		Thumbnails.of(f1).size(50, 50).toOutputStream(os);
	...
	public void of_File_toOutputStreams() throws IOException {
		...
		// when
		Thumbnails.of(f1).size(50, 50).toOutputStreams(Arrays.asList(os));
	...
	public void of_File_iterableBufferedImages() throws IOException {
		...
		// when
		Iterable<BufferedImage> thumbnails = Thumbnails.of(f1).size(50, 50).iterableBufferedImages();
	...
	public void of_Files_toFile() throws IOException {
		...
		try {
			// when
			Thumbnails.of(f, f).size(50, 50).toFile(outFile);
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot output multiple thumbnails to one file.", e.getMessage());
			throw e;
	...
	public void of_Files_toFiles_Rename() throws IOException {
		...
		// when
		Thumbnails.of(f1, f2).size(50, 50).toFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void of_Files_asFiles_Rename() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.of(f1, f2).size(50, 50).asFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void of_Files_toFiles_Iterable() throws IOException {
		...
		// when
		Thumbnails.of(f1, f2).size(50, 50).toFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_Files_asFiles_Iterable() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.of(f1, f2).size(50, 50).asFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_Files_asBufferedImage() throws IOException {
		...
		try {
			// when
			Thumbnails.of(f, f).size(50, 50).asBufferedImage();
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot create one thumbnail from multiple original images.", e.getMessage());
			throw e;
	 ...
	 * and the expected outcome is,
	 * <ol>
	 * <li>Two images are generated and returned as BufferedImages in a
	 * List</li>
	 * </ol>
	 * 
	 * @throws IOException
	...
	public void of_Files_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.of(f1, f2).size(50, 50).asBufferedImages();
	...
	public void of_Files_toOutputStream() throws IOException {
		...
		try {
			// when
			Thumbnails.of(f, f).size(50, 50).toOutputStream(os);
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot output multiple thumbnails to a single OutputStream.", e.getMessage());
	...
	public void of_Files_toOutputStreams() throws IOException {
		...
		// when
		Thumbnails.of(f, f).size(50, 50).toOutputStreams(Arrays.asList(os1, os2));
	...
	public void of_Files_iterableBufferedImages() throws IOException {
		...
		// when
		Iterable<BufferedImage> thumbnails = Thumbnails.of(f1, f2).size(50, 50).iterableBufferedImages();
	...
	public void fromFiles_Single_toFile() throws IOException {
		...
		// when
		Thumbnails.fromFiles(Arrays.asList(f)).size(50, 50).toFile(outFile);
	...
	public void fromFiles_Multiple_toFile() throws IOException {
		...
		// when
		Thumbnails.fromFiles(Arrays.asList(f, f)).size(50, 50).toFile(outFile);
	}
	...
	public void fromFiles_Single_toFiles() throws IOException {
		...
		// when
		Thumbnails.fromFiles(Arrays.asList(f1)).size(50, 50).toFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFiles_Multiple_toFiles() throws IOException {
		...
		// when
		Thumbnails.fromFiles(Arrays.asList(f1, f2)).size(50, 50).toFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFiles_Single_asFiles() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.fromFiles(Arrays.asList(f1)).size(50, 50)
	...
	public void fromFiles_Multiple_asFiles() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.fromFiles(Arrays.asList(f1, f2)).size(50, 50)
				.asFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFilesIterable_Single_toFile() throws IOException {
		...
		// when
		Thumbnails.fromFiles((Iterable<File>) Arrays.asList(f)).size(50, 50).toFile(outFile);
	...
	public void fromFilesIterable_Multiple_toFile() throws IOException {
		...
		// when
		Thumbnails.fromFiles((Iterable<File>) Arrays.asList(f, f)).size(50, 50).toFile(outFile);
	}
	...
	public void fromFilesIterable_Single_toFiles() throws IOException {
		...
		// when
		Thumbnails.fromFiles((Iterable<File>) Arrays.asList(f1)).size(50, 50).toFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFilesIterable_Multiple_toFiles() throws IOException {
		...
		// when
		Thumbnails.fromFiles((Iterable<File>) Arrays.asList(f1, f2)).size(50, 50).toFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFilesIterable_Single_asFiles() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.fromFiles((Iterable<File>) Arrays.asList(f1)).size(50, 50)
				.asFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFilesIterable_Multiple_asFiles() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.fromFiles((Iterable<File>) Arrays.asList(f1, f2)).size(50, 50)
				.asFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFilenames_Single_toFile() throws IOException {
		...
		// when
		Thumbnails.fromFilenames(Arrays.asList(f)).size(50, 50).toFile(outFile);
	...
	public void fromFilenames_Multiple_toFile() throws IOException {
		...
		// when
		Thumbnails.fromFilenames(Arrays.asList(f, f)).size(50, 50).toFile(outFile);
	}
	...
	public void fromFilenames_Single_toFiles() throws IOException {
		...
		// when
		Thumbnails.fromFilenames(Arrays.asList(f1)).size(50, 50).toFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFilenames_Multiple_toFiles() throws IOException {
		...
		// when
		Thumbnails.fromFilenames(Arrays.asList(f1, f2)).size(50, 50).toFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFilenames_Single_asFiles() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.fromFilenames(Arrays.asList(f1)).size(50, 50)
				.asFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFilenames_Multiple_asFiles() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.fromFilenames(Arrays.asList(f1, f2)).size(50, 50)
				.asFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFilenamesIterable_Single_toFile() throws IOException {
		...
		// when
		Thumbnails.fromFilenames((Iterable<String>) Arrays.asList(f)).size(50, 50).toFile(outFile);
	...
	public void fromFilenamesIterable_Multiple_toFile() throws IOException {
		...
		// when
		Thumbnails.fromFilenames((Iterable<String>) Arrays.asList(f, f)).size(50, 50).toFile(outFile);
	}
	...
	public void fromFilenamesIterable_Single_toFiles() throws IOException {
		...
		// when
		Thumbnails.fromFilenames((Iterable<String>) Arrays.asList(f1)).size(50, 50)
	...
	public void fromFilenamesIterable_Multiple_toFiles() throws IOException {
		...
		// when
		Thumbnails.fromFilenames((Iterable<String>) Arrays.asList(f1, f2)).size(50, 50)
				.toFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFilenamesIterable_Single_asFiles() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.fromFilenames((Iterable<String>) Arrays.asList(f1)).size(50, 50)
				.asFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void fromFilenamesIterable_Multiple_asFiles() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.fromFilenames((Iterable<String>) Arrays.asList(f1, f2)).size(50, 50)
				.asFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void of_URL_asFiles_Rename() throws IOException {
		...
		try {
			// when
			Thumbnails.of(f1).size(50, 50).asFiles(Rename.PREFIX_DOT_THUMBNAIL);
		} catch (IllegalStateException e) {
			// then
			assertEquals("Cannot create thumbnails to files if original images are not from files.", e.getMessage());
			throw e;
	...
	public void of_URLs_asFiles_Rename() throws IOException {
		...
		try {
			// when
			Thumbnails.of(f1, f2).size(50, 50).asFiles(Rename.PREFIX_DOT_THUMBNAIL);
		} catch (IllegalStateException e) {
			// then
			assertEquals("Cannot create thumbnails to files if original images are not from files.", e.getMessage());
			throw e;
	...
	public void fromURLs_Single_asBufferedImage() throws IOException {
		...
		// when
		BufferedImage thumbnail = Thumbnails.fromURLs(Arrays.asList(url)).size(100, 100).asBufferedImage();
	...
	public void fromURLs_Multiple_asBufferedImage() throws IOException {
		...
		try {
			// when
			Thumbnails.fromURLs(Arrays.asList(url, url)).size(100, 100).asBufferedImage();
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot create one thumbnail from multiple original images.", e.getMessage());
			throw e;
	...
	public void fromURLs_Single_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.fromURLs(Arrays.asList(url)).size(100, 100).asBufferedImages();
	...
	public void fromURLs_Multiple_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.fromURLs(Arrays.asList(url, url)).size(100, 100).asBufferedImages();
	...
	public void fromURLsIterable_Single_asBufferedImage() throws IOException {
		...
		// when
		BufferedImage thumbnail = Thumbnails.fromURLs((Iterable<URL>) Arrays.asList(url)).size(100, 100)
				.asBufferedImage();
	...
	public void fromURLsIterable_Multiple_asBufferedImage() throws IOException {
		...
		try {
			// when
			Thumbnails.fromURLs((Iterable<URL>) Arrays.asList(url, url)).size(100, 100).asBufferedImage();
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot create one thumbnail from multiple original images.", e.getMessage());
			throw e;
	...
	public void fromURLsIterable_Single_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.fromURLs((Iterable<URL>) Arrays.asList(url)).size(100, 100)
				.asBufferedImages();
	...
	public void fromURLsIterable_Multiple_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.fromURLs((Iterable<URL>) Arrays.asList(url, url)).size(100, 100)
				.asBufferedImages();
	...
	public void of_InputStream_toFile() throws IOException {
		...
		// when
		Thumbnails.of(is).size(50, 50).toFile(outFile);
	...
	public void of_InputStream_toFiles_Rename() throws IOException {
		...
		try {
			// when
			Thumbnails.of(is).size(50, 50).toFiles(Rename.PREFIX_DOT_THUMBNAIL);
		} catch (IllegalStateException e) {
			// then
			assertEquals("Cannot create thumbnails to files if original images are not from files.", e.getMessage());
			throw e;
	...
	public void of_InputStream_asFiles_Rename() throws IOException {
		...
		try {
			// when
			Thumbnails.of(is).size(50, 50).asFiles(Rename.PREFIX_DOT_THUMBNAIL);
		} catch (IllegalStateException e) {
			// then
			assertEquals("Cannot create thumbnails to files if original images are not from files.", e.getMessage());
			throw e;
	...
	public void of_InputStream_toFiles_Iterable() throws IOException {
		...
		// when
		Thumbnails.of(is).size(50, 50).toFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_InputStream_asFiles_Iterable() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.of(is).size(50, 50).asFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_InputStream_asBufferedImage() throws IOException {
		...
		// when
		BufferedImage thumbnail = Thumbnails.of(is).size(50, 50).asBufferedImage();
	...
	public void of_InputStream_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.of(is).size(50, 50).asBufferedImages();
	...
	public void of_InputStream_toOutputStream() throws IOException {
		...
		// when
		Thumbnails.of(is).size(50, 50).toOutputStream(os);
	...
	public void of_InputStream_toOutputStreams() throws IOException {
		...
		// when
		Thumbnails.of(is).size(50, 50).toOutputStreams(Arrays.asList(os));
	...
	public void of_InputStream_iterableBufferedImages() throws IOException {
		...
		// when
		Iterable<BufferedImage> thumbnails = Thumbnails.of(is).size(50, 50).iterableBufferedImages();
	...
	public void of_InputStreams_toFile() throws IOException {
		...
		try {
			// when
			Thumbnails.of(is, is).size(50, 50).toFile(outFile);
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot output multiple thumbnails to one file.", e.getMessage());
			throw e;
	...
	public void of_InputStreams_toFiles_Rename() throws IOException {
		...
		try {
			// when
			Thumbnails.of(is1, is2).size(50, 50).toFiles(Rename.PREFIX_DOT_THUMBNAIL);
		} catch (IllegalStateException e) {
			// then
			assertEquals("Cannot create thumbnails to files if original images are not from files.", e.getMessage());
			throw e;
	...
	public void of_InputStreams_asFiles_Rename() throws IOException {
		...
		try {
			// when
			Thumbnails.of(is1, is2).size(50, 50).asFiles(Rename.PREFIX_DOT_THUMBNAIL);
		} catch (IllegalStateException e) {
			// then
			assertEquals("Cannot create thumbnails to files if original images are not from files.", e.getMessage());
			throw e;
	...
	public void of_InputStreams_toFiles_Iterable() throws IOException {
		...
		// when
		Thumbnails.of(is1, is2).size(50, 50).toFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_InputStreams_asFiles_Iterable() throws IOException {
		...
		// when
		List<File> thumbnails = Thumbnails.of(is1, is2).size(50, 50).asFiles(
				new ConsecutivelyNumberedFilenames(new File("src/test/resources/Thumbnailator"), "temp-%d.png"));
	...
	public void of_InputStreams_asBufferedImage() throws IOException {
		...
		try {
			// when
			Thumbnails.of(is, is).size(50, 50).asBufferedImage();
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot create one thumbnail from multiple original images.", e.getMessage());
			throw e;
	...
	public void of_InputStreams_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.of(is1, is2).size(50, 50).asBufferedImages();
	...
	public void of_InputStreams_toOutputStream() throws IOException {
		...
		try {
			// when
			Thumbnails.of(is, is).size(50, 50).toOutputStream(os);
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot output multiple thumbnails to a single OutputStream.", e.getMessage());
			verifyZeroInteractions(os);
	...
	public void of_InputStreams_toOutputStreams() throws IOException {
		...
		// when
		Thumbnails.of(is1, is2).size(50, 50).toOutputStreams(Arrays.asList(os1, os2));
	...
	public void of_InputStreams_iterableBufferedImages() throws IOException {
		...
		// when
		Iterable<BufferedImage> thumbnails = Thumbnails.of(is1, is2).size(50, 50).iterableBufferedImages();
	...
	public void fromInputStreams_Single_asBufferedImage() throws IOException {
		...
		// when
		BufferedImage thumbnail = Thumbnails.fromInputStreams(Arrays.asList(is)).size(100, 100).asBufferedImage();
	...
	public void fromInputStreams_Multiple_asBufferedImage() throws IOException {
		...
		try {
			// when
			Thumbnails.fromInputStreams(Arrays.asList(is, is)).size(100, 100).asBufferedImage();
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot create one thumbnail from multiple original images.", e.getMessage());
			throw e;
	...
	public void fromInputStreams_Single_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.fromInputStreams(Arrays.asList(is)).size(100, 100)
				.asBufferedImages();
	...
	public void fromInputStreams_Multiple_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.fromInputStreams(Arrays.asList(is1, is2)).size(100, 100)
				.asBufferedImages();
	...
	public void fromInputStream_Multiple_FileInputStream_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails.fromInputStreams(Arrays.asList(fis1, fis2)).size(100, 100)
				.asBufferedImages();
	...
	public void fromInputStreamsIterable_Single_asBufferedImage() throws IOException {
		...
		// when
		BufferedImage thumbnail = Thumbnails.fromInputStreams((Iterable<InputStream>) Arrays.asList(is)).size(100, 100)
				.asBufferedImage();
	...
	public void fromInputStreamsIterable_Multiple_asBufferedImage() throws IOException {
		...
		try {
			// when
			Thumbnails.fromInputStreams((Iterable<InputStream>) Arrays.asList(is, is)).size(100, 100).asBufferedImage();
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot create one thumbnail from multiple original images.", e.getMessage());
			throw e;
	 ...
	 * Test for the {@link Thumbnails.Builder} class where,
	 * <ol>
	 * <li>Thumbnails.fromImages(Iterable[FileInputStream,
	 * FileInputStream])</li>
	 * <li>asBufferedImage()</li>
	 * </ol>
	 * and the expected outcome is,
	...
	public void fromInputStreamsIterable_Multiple_FileInputStream_asBufferedImage() throws IOException {
		...
		try {
			// when
			Thumbnails.fromInputStreams((Iterable<FileInputStream>) Arrays.asList(is, is)).size(100, 100)
					.asBufferedImage();
		} catch (IllegalArgumentException e) {
			// then
			assertEquals("Cannot create one thumbnail from multiple original images.", e.getMessage());
	...
	public void fromInputStreamIterable_Multiple_FileInputStream_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> thumbnails = Thumbnails
				.fromInputStreams((Iterable<FileInputStream>) Arrays.asList(fis1, fis2)).size(100, 100)
				.asBufferedImages();
	...
	public void fileSizeDecreasesAfterResize() throws IOException {
		...
		// when
		Thumbnails.of(f).size(100, 100).toFile(f);
	...
	public void toFile_File_AllowOverwrite() throws IOException {
		...
		// when
		Thumbnails.of(f).size(100, 100).allowOverwrite(true).toFile(f);
	...
	public void toFile_File_DisallowOverwrite() throws IOException {
		...
		// when
		try {
			Thumbnails.of(f).size(100, 100).allowOverwrite(false).toFile(f);
	...
	public void toFile_String_AllowOverwrite() throws IOException {
		...
		// when
		Thumbnails.of(f).size(100, 100).allowOverwrite(true).toFile(f.getAbsolutePath());
	...
	public void toFile_String_DisallowOverwrite() throws IOException {
		...
		// when
		try {
			Thumbnails.of(f).size(100, 100).allowOverwrite(false).toFile(f.getAbsolutePath());
	...
	public void toFilesIterable_AllowOverwrite_SingleFile_OutputFileDoesNotExist() throws IOException {
		...
		// when
		Thumbnails.of(originalFile).size(100, 100).allowOverwrite(true).toFiles(Arrays.asList(fileThatDoesntExist));
	...
	public void toFilesIterable_AllowOverwrite_SingleFile_OutputFileExists() throws IOException {
		...
		// when
		Thumbnails.of(originalFile).size(100, 100).allowOverwrite(true).toFiles(Arrays.asList(fileThatExists));
	...
	public void toFilesIterable_DisallowOverwrite_SingleFile_OutputFileDoesNotExist() throws IOException {
		...
		// when
		Thumbnails.of(originalFile).size(100, 100).allowOverwrite(false).toFiles(Arrays.asList(fileThatDoesntExist));
	...
	public void toFilesIterable_DisallowOverwrite_SingleFile_OutputFileExists() throws IOException {
		...
		// when
		Thumbnails.of(originalFile).size(100, 100).allowOverwrite(false).toFiles(Arrays.asList(fileThatExists));
	...
	public void toFilesIterable_AllowOverwrite_MultipleFiles_AllOutputFilesDoNotExist() throws IOException {
		...
		// when
		Thumbnails.of(originalFile, originalFile).size(100, 100).allowOverwrite(true)
	...
	public void toFilesIterable_DisallowOverwrite_MultipleFiles_AllOutputFilesDoNotExist() throws IOException {
		...
		// when
		Thumbnails.of(originalFile, originalFile).size(100, 100).allowOverwrite(false)
				.toFiles(Arrays.asList(fileThatDoesntExist1, fileThatDoesntExist2));
	...
	public void asFilesIterable_AllowOverwrite_SingleFile_OutputFileDoesNotExist() throws IOException {
		...
		// when
		List<File> list = Thumbnails.of(originalFile, originalFile).size(100, 100).allowOverwrite(true)
	...
	public void asFilesIterable_DisallowOverwrite_SingleFiles_OutputFileDoesNotExist() throws IOException {
		...
		// when
		List<File> list = Thumbnails.of(originalFile, originalFile).size(100, 100).allowOverwrite(false)
				.asFiles(Arrays.asList(fileThatDoesntExist1, fileThatDoesntExist2));
	...
	public void toFilesRename_AllowOverwrite_SingleFile_OutputFileDoesNotExist() throws IOException {
		...
		// when
		Thumbnails.of(originalFile).size(100, 100).allowOverwrite(true).toFiles(rename);
	...
	public void toFilesRename_DisallowOverwrite_SingleFile_OutputFileDoesNotExist() throws IOException {
		...
		// when
		Thumbnails.of(originalFile).size(100, 100).allowOverwrite(false).toFiles(rename);
	...
	public void toFilesRename_AllowOverwrite_MultipleFiles_AllOutputFilesDoNotExist() throws IOException {
		...
		// when
		Thumbnails.of(originalFile1, originalFile2).size(100, 100).allowOverwrite(true).toFiles(rename);
	...
	public void toFilesRename_DisallowOverwrite_MultipleFiles_AllOutputFilesDoNotExist() throws IOException {
		...
		// when
		Thumbnails.of(originalFile1, originalFile2).size(100, 100).allowOverwrite(false).toFiles(rename);
	...
	public void asFilesRename_AllowOverwrite_SingleFile_OutputFileDoesNotExist() throws IOException {
		...
		// when
		List<File> list = Thumbnails.of(originalFile).size(100, 100).allowOverwrite(true).asFiles(rename);
	...
	public void asFilesRename_DisallowOverwrite_SingleFile_OutputFileDoesNotExist() throws IOException {
		...
		// when
		List<File> list = Thumbnails.of(originalFile).size(100, 100).allowOverwrite(false).asFiles(rename);
	...
	public void asFilesRename_AllowOverwrite_MultipleFiles_AllOutputFilesDoNotExist() throws IOException {
		...
		// when
		List<File> list = Thumbnails.of(originalFile1, originalFile2).size(100, 100).allowOverwrite(true)
				.asFiles(rename);
	...
	public void asFilesRename_DisallowOverwrite_MultipleFiles_SomeOutputFilesDoNotExist() throws IOException {
		...
		// when
		List<File> list = Thumbnails.of(originalFile1, originalFile2).size(100, 100).allowOverwrite(false)
				.asFiles(rename);
	...
	public void toFile_SourceExtensionIsjpg_DestExtensionIsjpg() throws IOException {
		...
		// when
		Thumbnails.of(f).size(10, 10).toFile(destFile);
	...
	public void toFile_SourceExtensionIsjpg_DestExtensionIsjpg_OutputFormatIsjpg() throws IOException {
		...
		// when
		Thumbnails.of(f).size(10, 10).outputFormat("jpg").toFile(destFile);
	...
	public void toFile_SourceExtensionIsjpg_DestExtensionIsjpg_OutputFormatIsJPEG() throws IOException {
		...
		// when
		Thumbnails.of(f).size(10, 10).outputFormat("JPEG").toFile(destFile);
	...
	public void toFiles_Rename_WritesToSameDir_AllInputFromSameDir() throws IOException {
		...
		// when
		Thumbnails.of(f1, f2).size(100, 100).toFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void toFiles_Rename_WritesToSpecifiedDir_AllInputFromSameDir() throws IOException {
		...
		// when
		Thumbnails.of(f1, f2).size(100, 100).toFiles(new File(targetDir), Rename.PREFIX_DOT_THUMBNAIL);
	...
	@Test
	public void toFiles_Rename_WritesToSpecifiedDir_InputsFromDifferentDir_InputSameName_OverwriteFalse()
			throws IOException {
		// given
		File sourceFile1 = new File("src/test/resources/Thumbnailator/grid.png");
		File sourceFile2 = new File("src/test/resources/Thumbnailator/igrid.png");
		...
		// when
		Thumbnails.of(f1, f2).size(100, 100).allowOverwrite(false).toFiles(new File(targetDir),
	...
	@Test
	public void toFiles_Rename_WritesToSpecifiedDir_InputsFromDifferentDir_InputSameName_OverwriteTrue()
			throws IOException {
		// given
		File sourceFile1 = new File("src/test/resources/Thumbnailator/grid.png");
		File sourceFile2 = new File("src/test/resources/Thumbnailator/igrid.png");
		...
		// when
		Thumbnails.of(f1, f2).size(100, 100).allowOverwrite(true).toFiles(new File(targetDir),
				Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void toFiles_Rename_WritesToSpecifiedDir_OutputDirDoesntExist() throws IOException {
		...
		try {
			// when
			Thumbnails.of(f1).size(100, 100).toFiles(new File(targetDir), Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void asFiles_Rename_WritesToSameDir_AllInputFromSameDir() throws IOException {
		...
		// when
		List<File> result = Thumbnails.of(f1, f2).size(100, 100).asFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void asFiles_Rename_WritesToSpecifiedDir_AllInputFromSameDir() throws IOException {
		...
		// when
		List<File> result = Thumbnails.of(f1, f2).size(100, 100).asFiles(new File(targetDir),
				Rename.PREFIX_DOT_THUMBNAIL);
	...
	@Test
	public void asFiles_Rename_WritesToSpecifiedDir_InputsFromDifferentDir_InputSameName_OverwriteFalse()
			throws IOException {
		// given
		File sourceFile1 = new File("src/test/resources/Thumbnailator/grid.png");
		File sourceFile2 = new File("src/test/resources/Thumbnailator/igrid.png");
		...
		// when
		List<File> result = Thumbnails.of(f1, f2).size(100, 100).allowOverwrite(false).asFiles(new File(targetDir),
				Rename.PREFIX_DOT_THUMBNAIL);
	...
	@Test
	public void asFiles_Rename_WritesToSpecifiedDir_InputsFromDifferentDir_InputSameName_OverwriteTrue()
			throws IOException {
		// given
		File sourceFile1 = new File("src/test/resources/Thumbnailator/grid.png");
		File sourceFile2 = new File("src/test/resources/Thumbnailator/igrid.png");
		...
		// when
		List<File> result = Thumbnails.of(f1, f2).size(100, 100).allowOverwrite(true).asFiles(new File(targetDir),
				Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void asFiles_Rename_WritesToSpecifiedDir_OutputDirDoesntExist() throws IOException {
		...
		try {
			// when
			Thumbnails.of(f1).size(100, 100).asFiles(new File(targetDir), Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void useOriginalFormat() throws IOException {
		...
		// when
		Thumbnails.of(f).size(10, 10).useOriginalFormat().toFile(destFile);
	...
	public void determineOutputFormat() throws IOException {
		...
		// when
		Thumbnails.of(f).size(10, 10).determineOutputFormat().toFile(destFile);
	...
	public void correctOrientation1() throws IOException {
		...
		// when
		BufferedImage result = Thumbnails.of(sourceFile).size(100, 100).asBufferedImage();
	...
	public void correctOrientation1FromInputStream() throws IOException {
		...
		// when
		BufferedImage result = Thumbnails.of(is).size(100, 100).asBufferedImage();
	...
	public void multipleCallsCorrectOrientation_SameOrientation_asBufferedImages() throws IOException {
		// given
		// when
		List<BufferedImage> results = Thumbnails
				.of("src/test/resources/Exif/source_1.jpg", "src/test/resources/Exif/source_1.jpg").size(100, 100)
				.asBufferedImages();

		// then
		assertEquals(results.size(), 2);
		BufferedImageAssert.assertMatches(results.get(0), new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
		BufferedImageAssert.assertMatches(results.get(1), new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
	}
	...
	public void multipleCallsCorrectOrientation_DifferentOrientation_asBufferedImages() throws IOException {
		...
		// when
		List<BufferedImage> results = Thumbnails
				.of("src/test/resources/Exif/source_2.jpg", "src/test/resources/Exif/source_1.jpg").size(100, 100)
				.asBufferedImages();
	...
	public void multipleCallsCorrectOrientation_SameOrientation_iterableBufferedImages() throws IOException {
		// given
		// when
		Iterable<BufferedImage> results = Thumbnails
				.of("src/test/resources/Exif/source_1.jpg", "src/test/resources/Exif/source_1.jpg").size(100, 100)
				.iterableBufferedImages();

		// then
		Iterator<BufferedImage> iter = results.iterator();
		BufferedImageAssert.assertMatches(iter.next(), new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
		BufferedImageAssert.assertMatches(iter.next(), new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
		assertFalse(iter.hasNext());
	}
	...
	public void multipleCallsCorrectOrientation_SameOrientation_asFiles() throws IOException {
		...
		// when
		List<File> results = Thumbnails
				.of("src/test/resources/Exif/source_1.jpg", "src/test/resources/Exif/source_1.jpg").size(100, 100)
				.asFiles(Arrays.asList(outFile1, outFile2));

		// then
		assertEquals(results.size(), 2);
		BufferedImageAssert.assertMatches(ImageIO.read(results.get(0)), new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
		BufferedImageAssert.assertMatches(ImageIO.read(results.get(1)), new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
	}
	...
	public void multipleCallsCorrectOrientation_SameOrientation_asFilesRename() throws IOException {
		...
		// when
		List<File> results = Thumbnails.of(sourceFile1, sourceFile2).size(100, 100)
				.asFiles(Rename.PREFIX_DOT_THUMBNAIL);
	...
	public void multipleCallsCorrectOrientation_SameOrientation_toFiles() throws IOException {
		...
		// when
		Thumbnails.of("src/test/resources/Exif/source_1.jpg", "src/test/resources/Exif/source_1.jpg").size(100, 100)
				.toFiles(Arrays.asList(outFile1, outFile2));

		// then
		BufferedImageAssert.assertMatches(ImageIO.read(outFile1), new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
		BufferedImageAssert.assertMatches(ImageIO.read(outFile2), new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
	}
	...
	public void multipleCallsCorrectOrientation_DifferentOrientation_toFiles() throws IOException {
		...
		// when
		Thumbnails.of("src/test/resources/Exif/source_2.jpg", "src/test/resources/Exif/source_1.jpg").size(100, 100)
				.toFiles(Arrays.asList(outFile1, outFile2));
	...
	public void multipleCallsCorrectOrientation_SameOrientation_toFilesRename() throws IOException {
		...
		// when
		Thumbnails.of(sourceFile1, sourceFile2).size(100, 100).toFiles(Rename.PREFIX_DOT_THUMBNAIL);

		// then
		BufferedImageAssert.assertMatches(ImageIO.read(new File(TMPDIR, "thumbnail." + sourceFile1.getName())),
				new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
		BufferedImageAssert.assertMatches(ImageIO.read(new File(TMPDIR, "thumbnail." + sourceFile2.getName())),
				new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
	}
	...
	public void multipleCallsCorrectOrientation_SameOrientation_toOutputStreams() throws IOException {
		...
		// then
		BufferedImageAssert.assertMatches(ImageIO.read(new ByteArrayInputStream(os1.toByteArray())),
				new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
		BufferedImageAssert.assertMatches(ImageIO.read(new ByteArrayInputStream(os2.toByteArray())),
				new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
	}
	...
	public void useExifOrientationIsTrue_OrientationHonored() throws IOException {
		...
		List<File> results = Thumbnails
				.of("src/test/resources/Exif/source_2.jpg", "src/test/resources/Exif/source_1.jpg").size(100, 100)
				.useExifOrientation(true).asFiles(Arrays.asList(outFile1, outFile2));
	...
	public void useExifOrientationIsFalse_OrientationIgnored() throws IOException {
		...
		List<File> results = Thumbnails
				.of("src/test/resources/Exif/source_2.jpg", "src/test/resources/Exif/source_1.jpg").size(100, 100)
				.useExifOrientation(false).asFiles(Arrays.asList(outFile1, outFile2));

		// then
		assertEquals(results.size(), 2);
		BufferedImageAssert.assertMatches(ImageIO.read(results.get(0)), new float[] { 1, 1, 1, 1, 1, 1, 0, 0, 1, });
		BufferedImageAssert.assertMatches(ImageIO.read(results.get(1)), new float[] { 1, 1, 1, 1, 1, 1, 1, 0, 0, });
	}
	...
	public void toOutputStreamFailsWithoutOutputFormatSpecifiedForBufferedImage() throws IOException {
		...
		try {
			// when
			Thumbnails.of(img).size(100, 100).toOutputStream(baos);
	...
	public void toOutputStreamImageFormatMatchesInputForPngStream() throws IOException {
		...
		// when
		Thumbnails.of(is).size(100, 100).toOutputStream(baos);
	...
	public void toOutputStreamImageFormatMatchesInputForPngFile() throws IOException {
		...
		// when
		Thumbnails.of("src/test/resources/Thumbnailator/grid.png").size(100, 100).toOutputStream(baos);
	...
	public void toOutputStreamImageFormatMatchesInputForJpegFile() throws IOException {
		...
		// when
		Thumbnails.of("src/test/resources/Thumbnailator/grid.jpg").size(100, 100).toOutputStream(baos);
	...
	public void toOutputStreamImageFormatMatchesOutputFormatForPng() throws IOException {
		...
		// when
		Thumbnails.of("src/test/resources/Thumbnailator/grid.jpg").size(100, 100).outputFormat("png")
				.toOutputStream(baos);
	...
	public void toOutputStreamImageFormatMatchesOutputFormatForJpeg() throws IOException {
		...
		// when
		Thumbnails.of("src/test/resources/Thumbnailator/grid.jpg").size(100, 100).outputFormat("JPEG")
				.toOutputStream(baos);
	...
	public void toOutputStreamImageFormatMatchesOutputFormatForPngWithBufferedImageInput() throws IOException {
		...
		// when
		Thumbnails.of(img).size(100, 100).outputFormat("png").toOutputStream(baos);
	...
	public void toOutputStreamImageFormatMatchesOutputFormatForJpegWithBufferedImageInput() throws IOException {
		...
		// when
		Thumbnails.of(img).size(100, 100).outputFormat("JPEG").toOutputStream(baos);
